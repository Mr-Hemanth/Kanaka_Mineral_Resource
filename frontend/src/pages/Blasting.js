        ...
        <Box>
            ...
            {loading ? (
                ...
                <AdvancedTable
                    ...
                    searchableFields={['blastNumber', 'status', 'remarks']}
                />
            )}
            ...
            <Dialog open={recordDialog} onClose={() => setRecordDialog(false)} maxWidth="md" fullWidth>
                ...
                <DialogContent>
                    <Grid container spacing={2} sx={{ mt: 1 }}>
                        ...
                        {/* Remarks */}
                        <Grid item xs={12}><Divider sx={{ my: 1 }} /><Typography variant="subtitle1" fontWeight="bold" gutterBottom>Remarks</Typography></Grid>
