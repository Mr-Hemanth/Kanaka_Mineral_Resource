...
const getDashboardSummary = async (req, res) => {
    try {
        ...
        // Execute inside a single connection transaction to avoid network latency and connection pool limit crashes
        const [
            activeVehicles,
            totalVehicles,
            dieselLogs,
...
const getDashboardCharts = async (req, res) => {
    try {
        ...
        // Execute inside a single connection transaction to respect strict Serverless Connection Limits effortlessly
        const [
            revenueTrend,
            expenseTrend,
            dieselTrend,
